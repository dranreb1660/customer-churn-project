...
from customer-churn import config
from customer-churn.models.predict import predict
from customer-churn.response_handler import APIResponseHandler

ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'pdf', 'xlsx'}

app = Flask('Customer Churn Project')
app.config['UPLOAD_FOLDER'] = config.DATA_FOLDER
router = '/customer-churn-project/' + config.ENV
...
def hello():
    return 'Hello from Customer Churn Project!'
